...
INSERT INTO `SpotifyClone`.`artistas` (`artista_id`, `artista`) VALUES (4, 'Freddie Shannon');
...
INSERT INTO `SpotifyClone`.`cancoes` (`cancao_id`, `album_id`, `artista_id`, `cancao`) VALUES (4, 2, 1, 'Trouble Of My Inner Fire');
